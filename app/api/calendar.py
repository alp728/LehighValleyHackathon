...
from app.db.crud import create_calendar_source, add_calendar_event, get_user_calendar, delete_calendar_source
...
def add_event(event_data: CalendarEventCreate, source_id: Optional[int], db: Session = Depends(get_db), current_user = Depends(get_current_active_user)):
